...
```{r}
nas <- is.na(algae)
algae.del <- algae %>% filter(algae != NA)
```
...
Law of Positivity: Since this equation is the square root of a sum of positive numbers, $\|x-y\|_2 \geq 0$ holds, it is always positive
